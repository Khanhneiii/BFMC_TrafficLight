...
void TrafficLight_GPIOinit(void)
{
    ...
    esp_rom_gpio_pad_select_gpio(RED_LED);
    gpio_set_direction(RED_LED, GPIO_MODE_OUTPUT);
    esp_rom_gpio_pad_select_gpio(GREEB_LED);
    gpio_set_direction(GREEB_LED, GPIO_MODE_OUTPUT);
    esp_rom_gpio_pad_select_gpio(YELLOW_LED);
